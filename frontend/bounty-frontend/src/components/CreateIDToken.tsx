        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-1/3">
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <button
                className="text-white bg-green-600 hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 transition duration-200 ease-in-out"
                onClick={() => setFormVisible(true)}
              >
                Yes
              </button>
              <button
                className="text-white bg-red-600 hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 transition duration-200 ease-in-out"
